...
{
    public delegate void MyDelegate(ExecutionReport report);


    internal class ExecutionCommandViewItem : ListViewItem
    {
        internal ExecutionCommand Command { get; }
    ...
    {
        internal ExecutionReport Report { get; }
    ...
    internal class OrderViewItem : DataGridViewRow
    {
            ...
            get
            {
                ...
                switch (index)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        obj = Order.ProviderId;
                        break;
                    case 2:
                        obj = Order.Instrument.Symbol;
                        break;
                    case 3:
                        obj = Order.Side;
                        break;
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        obj = Order.AvgPx.ToString(Order.Instrument.PriceFormat);
                        break;
                    case 7:
                        obj = Order.Price.ToString(Order.Instrument.PriceFormat);
                        break;
                    case 8:
                        obj = Order.StopPx.ToString(Order.Instrument.PriceFormat);
                        break;
                    case 9:
                        obj = Order.Status;
                        break;
        ...
        {
            var viewCellCollection = new DataGridViewCellCollection((DataGridViewRow)this);
            for (var index = 0; index < this.columnCount; ++index)
                viewCellCollection.Add(new DataGridViewTextBoxCell());
